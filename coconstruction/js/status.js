...
(function() {
  var Controller, DB, DEVICE_ID, LAZY_SECONDS, NOTI_TIME, Notification, Pad, RATE, Status, deviceid, lib;
    ...
    _trackCallback = function(data) {
      ...
      for (_i = 0, _len = data.length; _i < _len; _i++) {
        ...
        if (status.isRead() || status.isSelf()) {
          ...
          if (status.isBUILD_UP_RETURN() || status.isNull()) {
