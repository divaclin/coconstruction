	...
	static function CustomizeImg(){
		echo '<canvas style="overflow:scroll;" id="canvas" width="1769" height="652" onload="createImage()"></canvas>
			  <div style="margin:0 auto; text-align:center;">
				...
				<button class="btn btn-success">recordAll</button>
				<button class="btn btn-danger">resetAll</button>
			  </div>';
	}
   ...
   static function Background($background){
	   switch ($background){
		   case 'email':
		        ...
		        break;
		   case 'project':
                echo'<script src="js/radian.js"></script><div id="radian"></div><article class="projectBackground" style="background:#000; background-image:url(\'img/projectBackground.gif\');" >'.self::Content($background).'</article>';   
		        break;
		   default:
