...
(function() {
  $(function() {
    var $radian, Audio, Controller, DB, DEVICE_ID, LAZY_SECONDS, NOTI_TIME, Notification, NotificationController, RATE, Status, Timer, db, lib, main, notificationController;
    $('title').text('沉浸式投影');
    $radian = $("#radian");
    ...
    Notification = (function() {
      ...
      Notification.prototype.getNotiTextStructure = function() {
        ...
        return "<p class=\"name\">" + (status.object_real.uname != null ? status.object_real.uname : "有使用者") + "</p>\n<p class=\"msg\">" + str + "<span class=\"bname\">" + status.object_real.bname + "</span></p>";
      };
    ...
    NotificationController = (function() {
      var $buildUpModal, $liveInModal, $notiContainer, THIS, isNotifying, notiArr, prpareNotiContainer;
      ...
      prpareNotiContainer = function(selector) {
        $(document).on('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', selector + ".fadeOut", function() {
          isNotifying = false;
          return THIS.next();
        });
        $(document).on('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', selector + ".fadeIn", function() {
          var timer;
          return timer = new Timer((function() {
            return $(this).fadeOut();
          }), NOTI_TIME);
        });
        $(selector).fadeIn = function() {
          $(selector).toggleClass('fadeOut', false);
          return $(selector).toggleClass('fadeIn', true);
        };
        $(selector).fadeOut = function() {
          $(selector).toggleClass('fadeOut', true);
          return $(selector).toggleClass('fadeIn', false);
        };
        return $(selector);
      };
      ...
      function NotificationController() {
        ...
        console.info($liveInModal, $liveInModal.length);
        $buildUpModal = $("#buildUpModal");
        prpareNotiContainer("#liveInModal");
        prpareNotiContainer("#buildUpModal");
      }
